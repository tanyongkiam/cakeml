...
// Module: CakeML.Core.PrimSemEnv
// Imports: Init CakeML.Core.Semantics CakeML.Core.TypeSysProps CakeML.Core.TypeSoundInvariants
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_CakeML_Core_PrimSemEnv(uint8_t builtin, lean_object* w) {
lean_object * res;
