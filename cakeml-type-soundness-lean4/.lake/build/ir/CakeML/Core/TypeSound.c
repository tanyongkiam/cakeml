...
// Module: CakeML.Core.TypeSound
// Imports: Init CakeML.Core.Weakening CakeML.Core.EvaluateProps CakeML.Core.Semantics CakeML.Core.PrimSemEnv
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_CakeML_Core_TypeSound(uint8_t builtin, lean_object* w) {
lean_object * res;
